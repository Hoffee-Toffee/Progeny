...
export default {
  ...
  get_number: {
    ...
    action: function (variable: string, state: any) {
    ...
    mutations: [
      {
        ...
        change: function (block: Block) {
          ...
          return [
            {
              blockName: 'multiply',
              inputs: [inputA, { blockName: 'number', values: { NUM: 2 } }],
            },
          ]
        },
      },
  ...
  multiply: {
    ...
    jsGenerator: function (block: Block, generator: Generator) {
      const a =
        generator.valueToCode(block, 'A', generator.ORDER_MULTIPLICATION) || '0'
      const b =
        generator.valueToCode(block, 'B', generator.ORDER_MULTIPLICATION) || '0'
      const code = `${a} * ${b}`
  ...
  power: {
    ...
    jsGenerator: function (block: Block, generator: Generator) {
      const base =
        generator.valueToCode(block, 'BASE', generator.ORDER_EXPONENTIATION) ||
        '1'
      const exponent =
  ...
  negate: {
    ...
    jsGenerator: function (block: Block, generator: Generator) {
      const input =
        generator.valueToCode(block, 'INPUT', generator.ORDER_UNARY_NEGATION) ||
        '0'
      const code = `-${input}`
  ...
  or: {
    ...
    jsGenerator: function (block: Block, generator: Generator) {
      const a =
        generator.valueToCode(block, 'A', generator.ORDER_LOGICAL_OR) || 'false'
      const b =
        generator.valueToCode(block, 'B', generator.ORDER_LOGICAL_OR) || 'false'
      const code = `${a} || ${b}`
      ...
      },
      {
        ...
        change: function (block: Block) {
          ...
          const aIsFalse =
            inputA.type === 'custom_boolean' &&
            getFieldValue(inputA, 'BOOL') === 'FALSE'
          return (aIsFalse ? [inputB] : [inputA]).filter(Boolean) as Block[]
        },
      },
      {
        condition: function (block: Block) {
  ...
  not: {
    ...
    jsGenerator: function (block: Block, generator: Generator) {
      const input =
        generator.valueToCode(block, 'INPUT', generator.ORDER_LOGICAL_OR) ||
        'false'
      const code = `!${input}`
      return [code, generator.ORDER_LOGICAL_OR]
    },
